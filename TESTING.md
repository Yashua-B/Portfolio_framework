...
## 2. Image Rendering
- With `images.txt` present, ensure images load in the specified order and all pages appear.
- Remove or rename `images.txt` and refresh; confirm numbered files (`page_01.png`, etc.) auto-load in ascending order.
